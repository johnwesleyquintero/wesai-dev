...
const CodeBlock: React.FC<{ code: string }> = ({ code }) => {
    ...
    return (
        <div className="bg-slate-100 dark:bg-slate-900/70 rounded-lg overflow-hidden border border-slate-200 dark:border-slate-700/50 flex-1 flex flex-col min-h-0">
